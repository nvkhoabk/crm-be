...
class TestPackage(TestCase):
    ...
    def test_package(self):
        ...
        self.assertEqual(create_package_func_url, '/api/manage/create_package/')
        ...
        self.assertEqual(update_package_func_url, '/api/manage/update_package/')
        ...
        self.assertEqual(filter_package_func_url, '/api/manage/filter_package/')
        ...
        self.assertEqual(delete_package_func_url, '/api/manage/delete_package/')
