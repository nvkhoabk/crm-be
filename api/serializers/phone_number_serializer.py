...
class FilterPhoneNumberRequestParamSerializer(serializers.Serializer):
    ...
    pickup_date_from = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    pickup_date_to = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    lock_date_from = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    lock_date_to = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    cancel_date_from = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    cancel_date_to = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    payment_date_from = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    payment_date_to = serializers.DateField(required=False, allow_null=True, allow_blank=True)
    ...
    phone_number_avg_age = serializers.FloatField(required=False, allow_null=True, allow_blank=True)
    lock_count = serializers.IntegerField(required=False, allow_null=True, allow_blank=True)
