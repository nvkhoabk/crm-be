...
urlpatterns = [
    ...
    path('manage/filter_technical_user/', manage.FilterTechnicalUserView.as_view(), name='manage.filter_technical_user'),
    ...
    path('phone_number/filter_phone_number_lock_history/',
     phone_number.FilterPhoneNumberLockHistoryView.as_view(),
     name='phone_number.filter_phone_number_lock_history'),
